...
def time_line():
    ...
    list7 = jinri_sum()
    x_data7 = ['2020-01', '2020-02', '2020-03', '2020-04', '2020-05', '2020-06', '2020-07', '2020-08', '2020-09',
    ...
    y_data11 = []
    for i in range(12):
        s = int(y_data1[i]) + int(y_data2[i]) + int(y_data3[i]) + int(y_data4[i]) + int(y_data5[i]) + int(y_data6[i]) + int(y_data7[i]) + int(y_data8[i]) + int(y_data9[i]) + int(y_data10[i])
        y_data11.append(s)

    return x_data1,y_data11
...
#         )
#         .set_global_opts(
#             title_opts=opts.TitleOpts(title="台海时间热度走势"),
...
#         )
#         .render("./templates/台海时间热度折线图.html")
#     )
#
